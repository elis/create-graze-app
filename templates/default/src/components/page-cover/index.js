    ...
    <div className={`bg-${bgColor || 'black-80'} pb5 pb5-m pb6-l v-mid cnt`}>
      <div className="mw9 center ph3-ns">
        <CoverSplit className="flex-wrap flex items-center ph2-ns">
          <CoverPitch className="w-100 w-100-m w-50-ns pa2">
            <div className="pv4">
              <div className='tc-s tc-m dt-s mt4 mt5-m mt4-l ph3'>
                {!pitch && children}
                {pitch && (
                  <React.Fragment>
                    <h1 className='f2 f1-l fw2 white-90 mb0 lh-title'>{pitch.title}</h1>
          ...
          <CoverBrand className="w-100 w-100-m w-50-ns v-mid dib tc">
            {art && (typeof art === 'string'
              ? <img src={art} alt={pitch.title} />
              : art
            )}
          </CoverBrand>
        </CoverSplit>
